        ...
        <div className={'infoBox'}>
          ...
          <div className={'description'}>
            <p>
              ...
              from Clair Davies{' '}
              <span className={'bold'}>“Trigger Point Therapy Work Book”.</span>{' '}
              Now you can make your own pain go away without relying on anybody.
            </p>
            <p>
        ...
        <div className={'infoBox'}>
          ...
          <div className={'description'}>
            <ul>
              ...
              <li>
                We will show you a list of techniques focused on addressing that
                area.
              </li>
              <li>
            ...
            <p className={cls.emoBullet}>
              ...
              <p>
                <span className={'bold'}>Bonus:</span> Email us and let us know
                if these technique are effective for you. We’d love to learn and
                continue to improve on the library.
              </p>
            </p>
          </div>
        </div>
